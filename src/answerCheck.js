 ...
 * Browser copy — keep in sync with /answerCheck.js for the Express server.
 */
...
export function compareAnswer(userAnswer, expectedAnswer, context = {}) {
...
export function getAnswerInputConfig(question = {}) {
...
export function sanitizeAnswerInput(value, format) {
