// Achievement badge catalog — shared shape with badges.js (server copy).
// Keep both files in sync when adding/editing badges; this one is imported by
// App.jsx (ES module), the other is required by server.js (CommonJS).
//
